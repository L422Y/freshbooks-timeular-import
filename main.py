...
from common import init_freshbooks_client, get_timeular_activities, get_timeular_entries, send_entries_to_freshbooks, get_timeular_token
...
send_entries_to_freshbooks(freshbooks_client, activities, entries)
